...
-----END CERTIFICATE-----
  ...
  context "PEM のタイプを判別する場合" do
    it ".get_asn1_type(crl_pem) は :crl を返すこと" do
      crl_pem = <<-CRL
-------BEGIN X509 CRL-----

-------END X509 CRL-----
      CRL
